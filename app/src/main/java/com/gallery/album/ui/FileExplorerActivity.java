...
import com.gallery.album.adapter.fileExplorer.FileExplorerAdapter;
import com.gallery.album.data.fileOperations.Copy;
import com.gallery.album.data.fileOperations.Delete;
...
import com.gallery.album.data.provider.FilesProvider;
import com.gallery.album.data.provider.Provider;
import com.gallery.album.data.models.StorageRoot;
...
public class FileExplorerActivity extends ThemeableActivity
        implements SwipeBackCoordinatorLayout.OnSwipeListener, FileExplorerAdapter.Callback,NetworkStateReceiver.NetworkStateReceiverListener {
